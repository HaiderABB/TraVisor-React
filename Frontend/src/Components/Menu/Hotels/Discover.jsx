...
const Discover = () => {
  return (
    <div style={{ width: '100%' }}>
      <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: '2%', fontFamily: 'Karla', backgroundColor: '#FAFBFC' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'row', paddingTop: '1%', placeContent: 'center', paddingBottom: '3%', gap: '0.5rem', padding: '1%' }}>
        <div style={{ backgroundColor: '#276968', width: '50%', borderRadius: '0.5rem', display: 'flex', flexDirection: 'column' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', padding: '3%', fontFamily: 'Montserrat Alternates' }}>
            ...
            <div style={{ backgroundColor: '#FFFFFF', color: '#276968', borderRadius: '0.5rem', display: 'flex', alignItems: 'center', width: '10%' }}>
              <p style={{ fontSize: '0.8rem', textAlign: "-webkit-center" }}>From <span style={{ fontWeight: 'bold', fontSize: '1.2rem' }}>$200</span></p>
            </div>
          </div>
